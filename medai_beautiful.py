...
if st.session_state.page == "chat":
    ...
    <div class="action-row">
        ...
        <div class="suggest-wrap">
            <button class="suggest-toggle" onclick="toggleSuggest()">
                💡 Quick questions ▼
            </button>
            <div class="suggest-dropdown" id="suggestDrop">
                <button class="suggest-item" onclick="fillChat('What causes chest pain?')">What causes chest pain?</button>
                <button class="suggest-item" onclick="fillChat('What are symptoms of diabetes?')">What are symptoms of diabetes?</button>
                <button class="suggest-item" onclick="fillChat('How does cancer develop?')">How does cancer develop?</button>
                <button class="suggest-item" onclick="fillChat('Signs of a heart attack?')">Signs of a heart attack?</button>
                <button class="suggest-item" onclick="fillChat('How to boost immune system?')">How to boost immunity?</button>
                <button class="suggest-item" onclick="fillChat('What causes headache?')">What causes headache?</button>
                <button class="suggest-item" onclick="fillChat('How to treat depression?')">How to treat depression?</button>
                <button class="suggest-item" onclick="fillChat('Signs of stroke?')">Signs of stroke?</button>
                <button class="suggest-item" onclick="fillChat('What is Alzheimers disease?')">What is Alzheimer's?</button>
                <button class="suggest-item" onclick="fillChat('How does chemotherapy work?')">How does chemotherapy work?</button>
            </div>
        </div>
    ...
    function toggleSuggest() {
        var d = document.getElementById('suggestDrop');
        d.classList.toggle('open');
    }
    document.addEventListener('click', function(e) {
        var wrap = document.querySelector('.suggest-wrap');
        if (wrap && !wrap.contains(e.target)) {
            document.getElementById('suggestDrop').classList.remove('open');
        }
    });
    function fillChat(q) {
    ...
    function startVoice() {
        ...
        if (!('webkitSpeechRecognition' in window) && !('SpeechRecognition' in window)) {
            status.textContent = '⚠️ Use Chrome browser for voice!';
            return;
        }
        ...
        recognition.onstart = function() {
            ...
            status.textContent = 'Speak in ANY language...';
        };
        ...
        recognition.onerror = function(e) {
            ...
            isListening = false;
            btn.textContent = '🎤 Speak in any language';
