...
if st.session_state.page == "chat":
    ...
    # ── Voice Input using Streamlit audio ──
    st.markdown("**🎤 Voice Input** — speak your medical question in any language:")
    audio = st.audio_input("Click microphone to speak")
    if audio:
        import io
        ...
        languages = ["en-US","hi-IN","te-IN","ta-IN","ar-SA","zh-CN","es-ES","fr-FR","de-DE","ja-JP","ko-KR"]
        voice_text = None
        ...
        if voice_text:
            st.session_state.auto_question = voice_text
            st.rerun()
        else:
